                ...
                .map((section, i) => (
                    ...
                    >
                        <table style={{
                            ...
                            fontSize: "15px",
                            color: "#d1d5db",
                            border: "none",        // ✅ explicitly removes table border
                            outline: "none",       // ✅ explicitly removes table outline
                            boxShadow: "none"      // ✅ ensures no default shadows
                        }}>
                            ...
                            <tbody>
                                {section.data.map((player, idx) => (
                                    <tr key={player._id} style={{ borderBottom: "1px solid #1a1a1a" }}>
                                        <td style={{ padding: "7px 10px", border: "none" }}>{idx + 1}. {player.name}</td>
                                        <td style={{ padding: "7px 10px", border: "none" }}>
